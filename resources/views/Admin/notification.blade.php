...
<head>
    ...
    <title>Dashoard Notification</title>
    <!-- bootstrap 5 css -->
    ...
    <div class=" my-container active-cont">
        ...
        <div class="col-md-10">
            ...
            <div class="main-content">
                <div class="text-center"><h3>Notification Lists</h3></div>
                <div class="mt-5 w-100">
                    <div class="table-responsive " style="margin-left: 9rem;">
                        <table class="table table-info table-hover">
                            <thead>
                                <tr>
                                  ...
                                  <th scope="col">Short Discrition</th>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>@mdo</td>
                                  <td>@mdo</td>
                                  <td><a href="productedit.html"><button type="submit" class="btn btn-info w-100">Show</button></a></td>
                                  <td class="btn btn-warning">Delete</td>
                                </tr>
