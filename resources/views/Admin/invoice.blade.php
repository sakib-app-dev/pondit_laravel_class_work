    ...
    <div class=" my-container active-cont">
        ...
        <div class="col-md-10">
          ...
          <div class="main-content ">
            <div class="mb-2 w-100 text-center p-3">
                <div class="card">
                    <div class="card-body mx-4 py-5">
                      <div class="container">
                        <p class="my-5 mx-5" style="font-size: 30px;">Thank for your Buyes</p>
                        <div class="row">
                          <ul class="list-unstyled">
                            <li class="text-black">Ajib</li>
                            <li class="text-muted mt-1"><span class="text-black">Invoice</span> #12345</li>
                            <li class="text-black mt-1">April 17 2022</li>
                          </ul>
                          <hr>
                          <div class="col-xl-10">
                            <p>Pro Package</p>
                          ...
                          <div class="col-xl-2">
                            <p class="float-end"><input type="text">
                            </p>
                          </div>
                          <hr>
                        </div>
                        ...
                        <div class="row text-black">
                          ...
                          <div class="col-xl-12">
                            <p class="float-end fw-bold">Total: <input type="text">
                            </p>
                          </div>
                          <hr style="border: 2px solid black;">
                        </div>
