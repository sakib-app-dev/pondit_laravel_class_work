...
<head>
    ...
    <title>Dashoard Update Profile</title>
    <!-- bootstrap 5 css -->
    ...
    <div class=" my-container active-cont">
        ...
        <div class="col-md-10">
            ...
            <div class="main-content">
                        ...
                        <div class="card p-3">
                            <div class=" w-100 ">
                                <img src="https://th.bing.com/th/id/R.8b167af653c2399dd93b952a48740620?rik=%2fIwzk0n3LnH7dA&pid=ImgRaw&r=0"
                                    ...
                                    <input type="file" value="image" id="image" class="image" name="image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="card py-4">
                            <div class="card-body text-center">
                                <h3 class="py-5">Shanto Bepary</h3>
                                <label for="changename">Type Your Name</label>
                                <input type="text" value="Shanto Bepary" class="form-control" name="changename" id="changename">
                                ...
                                <p class="py-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum,
                                    ...
                                    <textarea type="text" name="changedescription" id="changedescription" placeholder="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum,
                                    recusandae?"></textarea>
                ...
                <div class="card-body text-center">
                    <a href="profile.html"><BUtton type="submit" class="btn btn-success">Update Now</BUtton></a>
